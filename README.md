...
In the example below TaxSEA takes as input fold changes of bacterial species between healthy and Inflamatory Bowel Disease (IBD) and finds a statistically significant enrichment or depletion for various disease associated signatures, and producers of various metabolites. 
